...
<html lang="en">
<head>
  <title>Emploi | <?php echo $_SESSION['infos']['nom']; ?></title>
...
<ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="Offre.php"><span class="glyphicon glyphicon-transfer blue"></span> Appel d'offre</a></li>
        <li><a href="Annonce.php"><span class="glyphicon glyphicon-bullhorn blue"></span> Annonces</a></li>
        <li class="active"><a href="Emploi.php"><span class="glyphicon glyphicon-tags blue"></span> Offre d'emplois</a></li>
        <li><a href="Actualite.php"><span class="glyphicon glyphicon-bookmark blue"></span> Actualités</a></li>
        </ul>
</div>
<div class="col-md-8">

<legend><center><p>Vos Offres d'emploi</p></center><a href="#"data-toggle="modal" data-target="#AjouterEmploi" class="btn btn-success">Ajouter un offre d'emploi</a></legend>

<form class="form-horizontal" action="" method="post">
<?php
$emplois=afficher_emploi($_SESSION['infos_generale']['id_entreprise']);
if(mysql_num_rows($emplois)>0){?>
...
echo "<tr id=\"".$emploi['id']."\"><td>".$emploi['titre']."</td><td>".$emploi['description']."</td><td>".$emploi['type']."</td><td><span class=\"glyphicon glyphicon-trash btn btn-danger\" ><input type=\"checkbox\" name=\"check_list[]\" id=\"document-0\" value=".$emploi['id']." ".$sel."></span> <span id=\"".$emploi['id']."M\" onclick=\"modifier_emploi(this.id);\" class=\"glyphicon glyphicon-pencil btn btn-success\" ></span></td></tr>";
}
?>            
...
echo"Pas d'offre d'emploi pour l'instant.";
...
if(isset($_POST['supprimeremploi'])){
if(!empty($_POST['check_list'])) {
foreach($_POST['check_list'] as $selected){

//appel à la fonction de suppression
supprimer_emploi($selected);echo "<script language=\"javascript\">waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 4000);</script>";
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><center>Emploi</center></h4>
<?php
if(isset($_POST['ajouteremploi'])){
$titre=htmlspecialchars($_POST['titre'],ENT_QUOTES);
$description=htmlspecialchars($_POST['description'],ENT_QUOTES);
$type_saisie=$_POST['type'];
ajouter_emploi($_SESSION['infos_generale']['id_entreprise'],$titre,$description,$type_saisie);
echo "<script language=\"javascript\">waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 4000);</script>";
?><meta http-equiv="refresh" content="1" /><?php
}
?>
        ...
        <div class="modal-body">
         <h4 style="color:rgb(68, 145, 152);font-size:26px;text-decoration: underline;">Ajouter un offre d'emploi</h4>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    ...
    <option value="CTT">CTT (contrat de travail temporaire)</option>
    <option value="CF">contrat de professionnalisation</option>
...
<div class="form-group">
  ...
  <div class="col-md-8">
    <button id="ajouteremploi" name="ajouteremploi" class="btn btn-success">Ajouter</button>
...
<div class="modal fade" id="ModifierEmploi" role="dialog">
    <div class="modal-dialog">
...
modifier_emploi($_POST['idemploi'],$titre,$description,$type_saisie);
echo "<script language=\"javascript\">waitingDialog.show();setTimeout(function () {waitingDialog.hide();}, 4000);</script>";
?><meta http-equiv="refresh" content="1" /><?php
}
?>
        ...
        <div class="modal-body">
         <h4 style="color:rgb(68, 145, 152);font-size:26px;text-decoration: underline;">Modifier un offre d'emploi</h4>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="button1id"></label>
  <div class="col-md-8">
    <input type="hidden" id="idemploi" name="idemploi">
    <button id="modifieremploi" name="modifieremploi" class="btn btn-success">Modifier</button>
    <button id="button2id" name="button2id" class="btn btn-danger" data-dismiss="modal">Annuler</button>
  </div>
</div>
</fieldset>
